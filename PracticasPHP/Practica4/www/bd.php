<?php
    ...
    function setActividad($nombreActividad,$precio,$descripcion,$recomendaciones,$fecha,$ubicacionNombre,$ubicacionUrl,$portada,$foto1,$foto2){
        ...
        $insercion = $conexion->prepare("INSERT INTO Actividad (nombre,fecha,descripcion,precio,recomendaciones,ubicacion_nombre,ubicacion_url,ruta) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");       
        $insercion->bind_param("sssissss",$nombreActividad,$fecha,$descripcion,$precio,$recomendaciones, $ubicacionNombre,$ubicacionUrl,$portada);
        $insercion->execute();
    ...
    function updateActividad($idAc,$nombreActividad,$descripcion,$precio,$recomendaciones,$fecha,$ubicacionNombre,$ubicacionUrl,$ruta){
        $conexionBD = ConexionBD::obtenerInstancia();
        $conexion = $conexionBD->obtenerConexion();
        ...
        $update = $conexion->prepare("
            ...
            WHERE id = ?
        ");
        $update->bind_param("ssssiissssssssssi", 
